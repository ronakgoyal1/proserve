...
export default function Terms() {
  return (
    <main className="static-page" style={{ padding: 'var(--space-8) 0', minHeight: '80vh' }}>
      <Helmet>
        <title>Terms of Service | ProServe</title>
        <meta name="description" content="ProServe Terms of Service." />
      </Helmet>
      ...
      <div className="container" style={{ maxWidth: '800px' }}>
        ...
        <div style={{ background: 'white', padding: 'var(--space-6)', borderRadius: 'var(--radius-lg)', boxShadow: 'var(--shadow-sm)', color: 'var(--color-gray-700)', lineHeight: 1.7 }}>
          ...
          <p>By accessing and using ProServe, you agree to be bound by these Terms of Service. If you do not agree to these terms, please do not use our marketplace.</p>
          
          <h3 style={{ margin: 'var(--space-4) 0 var(--space-2)' }}>2. Platform Role</h3>
          <p>ProServe is a marketplace connecting users with independent CA and CMA professionals. ProServe itself does not provide financial, tax, or legal advice.</p>
          ...
          <p>Any disputes arising from services booked on ProServe should first be attempted to resolve directly between the Client and Professional. Our Support Team can mediate if necessary.</p>
        </div>
      </div>
    </main>
  );
