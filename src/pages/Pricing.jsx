...
const PLANS = [
  {
    ...
    features: [
      ...
      { text: 'Direct WhatsApp Leads', included: false },
    ],
  },
  {
    label: 'Featured',
    name: 'Featured Listing',
    tagline: 'Maximum conversion & leads',
    price: '₹999',
    period: 'per year',
    cta: { label: 'Upgrade to Featured', href: '/login?tab=signup&role=professional&plan=featured' },
    features: [
      { text: 'Basic directory listing', included: true },
      { text: 'Standard search visibility', included: true },
      { text: 'Priority Search Placement', included: true },
      { text: 'Verified Badge', included: true },
      { text: 'Direct WhatsApp Leads', included: true },
    ],
  },
];
