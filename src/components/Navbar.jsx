    ...
    <>
      <nav className={`navbar ${scrolled ? 'scrolled' : ''}`} id="main-navbar">
        <div className="container navbar-inner">
          ...
          <div className="navbar-links">
            ...
            <Link to="/pricing" style={{ color: 'var(--accent-primary)', fontWeight: 600 }}>For Experts</Link>
            <Link to="/ai-discovery" style={{ display: 'flex', alignItems: 'center', gap: '4px', color: 'var(--accent-primary)', fontWeight: 600 }}>
      ...
      <div className={`mobile-menu ${mobileOpen ? 'open' : ''}`}>
        ...
        <div className="mobile-menu-links">
          ...
          <Link to="/search">Find Experts</Link>
          <Link to="/pricing" style={{ color: 'var(--accent-primary)', fontWeight: 600 }}>For Experts</Link>
          <Link to="/ai-discovery" style={{ color: 'var(--accent-primary)', fontWeight: 600 }}>AI Matchmaker</Link>
        </div>
